...
namespace Progress.Nuclia.Model
{
    ...
    public partial class Page1
    {
        ...
        internal Page1(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="Page1" />
    /// </summary>
    public class Page1JsonConverter : JsonConverter<Page1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Page1" />
        /// </summary>
        ...
        public override Page1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Page1(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Page1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="page1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Page1 page1, JsonSerializerOptions jsonSerializerOptions)
        {
            if (page1.StringOption.IsSet && page1.StringOption.Value != null)
                writer.WriteStringValue(page1.StringOption.Value);

            else if (page1.IntOption.IsSet && page1.IntOption.Value != null)
                writer.WriteNumberValue(page1.IntOption.Value.Value);
